	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		...
		<div class="offcanvas-left">
			<ul class="nav navbar-nav side-nav">
				@if ($nav_active == "home")<li class="active">@else<li>@endif<a href={{ URL::secure('safeadmin/manage'); }}><i class="menu-image fa fa-dashboard"></i>首页</a></li>
				@if ($nav_active == "secfile")<li class="active">@else<li>@endif<a href={{ URL::secure('safeadmin/secfile'); }}><i class="menu-image fa fa-secfile"></i>secfile</a></li>
				@if ($nav_active == "gitlab")<li class="active">@else<li>@endif<a href={{ URL::secure('safeadmin/gitlab'); }}><i class="menu-image fa fa-secfile"></i>gitlab</a></li>
				@if ($nav_active == "riochat")<li class="active">@else<li>@endif<a href={{ URL::secure('safeadmin/riochat'); }}><i class="menu-image fa fa-secfile"></i>riochat</a></li>
