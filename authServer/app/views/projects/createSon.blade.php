...
{{-- Content --}}
@section('caption')
    {{$projectGroupName}}创建子项目组
    @stop
    @section('content')

    {{ Form::open(array('url' => 'manage/addSonProjectGroup', 'class' => 'form-horizontal','role' => 'form' , 'method' => 'POST')) }}
            <!-- 用户组名称 -->
    <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
        {{ Form::label('name', '子项目组名称', array('class' => 'col-sm-2 control-label')) }}
        <div class="col-sm-3">
	...
	{{ Form::label('enname', '子项目组英文名称', array('class' => 'col-sm-2 control-label')) }}
	<div class="col-sm-3">
